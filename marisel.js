    ...
    async  function activateCrons() {
        ...
        zk.ev.on("connection.update", async (con) => {
            ...
            if (connection === "connecting") {
                console.log("ℹ️ Bugatti is connecting...");
            }
            else if (connection === 'open') {
                console.log("✅ Bugatti is Connected to WhatsApp! ☺️");
                console.log("--");
                ...
                console.log("Loading Bugatti Commands ...\n");
                fs.readdirSync(__dirname + "/bugatti").forEach((fichier) => {
                    if (path.extname(fichier).toLowerCase() == (".js")) {
                        try {
                            require(__dirname + "/bugatti/" + fichier);
